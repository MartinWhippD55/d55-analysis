...
DOC = {
    ...
    "blocks": [
        ...
        },
        {
            ...
            "pageBreak": True,
            "intro": "Reusable sections live under their own partition and are linked to templates by reference records. Section edits are versioned rather than overwritten.",
            "table": "ContractNoteTemplates",
            "entities": [
                {
                    "name": "Shared Section",
                ...
                },
                {
                    ...
                    "pk": "SHARED_SECTION#{sectionId}",
                    "sk": "REF#{templateId}",
                    "note": "One per template using the shared section; how references are tracked and counted.",
                    "attributes": [
                ...
                },
                {
                    ...
                    "pk": "SECTION_VERSION#{sectionId}",
                    "sk": "VERSION#{timestamp}",
                    "note": "Every schema save appends a version; nothing is overwritten, enabling history and revert.",
                    "attributes": [
