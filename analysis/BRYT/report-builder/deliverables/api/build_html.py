"""
Build a fully self-contained HTML rendering of the Report Builder OpenAPI spec.
...
Usage:
    python analysis/BRYT/report-builder/deliverables/api/build_html.py
"""
import json
...
SPEC = HERE / "report-builder-api.yaml"
RUNTIME = HERE / "_redoc.js"
OUTPUT = HERE / "report-builder-api.html"
