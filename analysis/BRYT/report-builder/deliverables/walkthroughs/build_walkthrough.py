"""
Reusable walkthrough document generator for the BRYT Report Builder deliverables.

Each document provides a content module (e.g. report_builder.py) exposing a DOC
dict. This engine renders that content into a branded, standalone HTML document
with embedded (base64) images, then Playwright renders the HTML to PDF.
...
Content model (DOC dict):
{
    ...
    "effort": "~78 developer days",          # cover badge (optional)
    "date": "August 2026",
    "blocks": [ <block>, ... ]
}
