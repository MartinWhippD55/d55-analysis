...
trigger:
  recommend_when_current_at_or_below: 3  # most orgs below "comprehensive" carry real risk
  include_when_gap_at_or_above: 2        # ambition-driven inclusion even from a decent base
  prioritise_when_gap_at_or_above: 2
  # Governance is a hard gate — critical applies ONLY to the governance dimension, not testing
  critical_dimensions:
    - Governance, Security & Compliance
