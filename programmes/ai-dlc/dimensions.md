# AI Development Lifecycle — Assessment Dimensions

These are the axes of the radar chart, scored 1–5 (current vs target). Dimension names here are the join key to module `dimensions_covered` and to assessment scores.
...
- **Pre-adoption orgs** — where a question asks "has X changed since adopting AI tooling"
  and the team hasn't adopted yet, score the current state low (1–2) and use the question
  to explore the *target* instead. The assessment is as valuable at the start line as mid-journey.
...
| 4 | Disciplined | AI-first delivery lifecycle in operation: more time in analysis/design, less in implementation. Specs written to be consumed by both humans and AI. Contracts and APIs defined upfront. Architectural decisions documented before build. |
...
- What are your concrete quality gates — coverage thresholds in CI, mutation testing, property-based testing? Do they apply equally to AI-generated code?
...
## The Four Fears Framework

*The diagnostic tool behind the "Team Adaptation & Skills" dimension. Resistance to
AI-assisted development is personality-driven, not stupidity — it needs diagnosing,
not steamrolling. Four fears block adoption, split across two axes (task- vs
people-oriented, past/present- vs future-leaning):*
...
- **Drivers** get faster, cheaper failure — compressed risk through tighter feedback loops.
- **Stabilisers** who lean in become orchestrators — *more* valuable, not less.
- **Influencers** get amplified — AI handles the grunt work, they get more stage.

Use this in the assessment to name where resistance sits, and in Module 4 (People &
Change) to plan tailored interventions per pattern.
...
- **Current State:** where the organisation is today (scored 1–5 per dimension).
- **Target State:** where they want to be in 12–18 months.

The gap between the two shapes is the opportunity. Each gap maps to a D55 service
offering (below), which is what turns the picture into a costed roadmap.

---

## Mapping Gaps to Services

Each dimension's gap points to concrete D55 services and to the programme module
that addresses it.

| Dimension | Example D55 Services | Module |
|-----------|---------------------|--------|
| Leadership & Mandate | AI-First Strategy Workshop, Investment Case Development, Board Presentation Support | Module 1 |
| Developer Tooling & Adoption | AI Tooling Rollout, Standard Configuration Build, MCP Server Setup, Knowledgebase Creation | Module 2 |
| Specification & Design Process | AI-First Delivery Lifecycle Workshop, Spec Template Development, Contract-First Design Coaching | Module 2 |
| Delivery Process & Ceremonies | Process Redesign Workshop, Ceremony Adaptation, Continuous Flow Implementation | Module 2 |
| Testing & Quality Assurance | Test Automation Strategy, AI-Assisted QA Setup, Playwright Regression Implementation | Module 3 |
| Governance, Security & Compliance | AI Usage Policy, DLP Implementation, EU AI Act Classification, Code Provenance Tooling | Module 3 |
| Team Adaptation & Skills | Four Fears Diagnostic & Intervention, Upskilling Programme, Role Redefinition Coaching | Module 4 |
| Metrics & ROI | Measurement Framework Setup, ROI Dashboard, Investment Case Packaging | Module 1 |
